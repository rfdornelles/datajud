...
[guia de contribuição](CONTRIBUTING.md), a
[política de compatibilidade](COMPATIBILIDADE.md) e o
[checklist de release](RELEASE.md). Revisão final, merge e publicação são
responsabilidade do mantenedor. Consulte também o
